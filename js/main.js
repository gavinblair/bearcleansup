...
function scene(thescene){
	...
	$('a').on('click touchup',function(){
		...
		if(!$(this).hasClass('target')){
			...
			//if we are on the left of the object, subtract the sprite's width
			var target = pos.left;
			if($('#sprite').hasClass('right')){
				target -= ($('#sprite').width()/1.5);
				console.log(target);
			}
...
var away = new Audio('audio/away.m4a');
var bearcleansup = new Audio('audio/bearcleansup.m4a');
var car = new Audio('audio/car.m4a');
var empty = new Audio('audio/empty.m4a');
var full = new Audio('audio/full.m4a');
var heywakeup = new Audio('audio/heywakeup.m4a');
var key = new Audio('audio/key.m4a');
var letsgo = new Audio('audio/letsgo.m4a');
var monkey = new Audio('audio/monkey.m4a');
var notabook = new Audio('audio/notabook.m4a');
var notatoy = new Audio('audio/notatoy.m4a');
var rhino = new Audio('audio/rhino.m4a');
var shouldbecleaning = new Audio('audio/shouldbecleaning.m4a');
var tigger = new Audio('audio/tigger.m4a');
var wakeupfred = new Audio('audio/wakeupfred.m4a');
var wedidit = new Audio('audio/wedidit.m4a');
